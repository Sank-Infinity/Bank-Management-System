...
public class deposit {
	...
	protected static final char[] inum = null;
	JFrame f;
	JLabel l1,l2;
	JButton b1,b2;
	JTextField t1;
		...
		b1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {	
					...
					stmt.executeUpdate("update cash_details set deposit = '"+str1+"' where Card_number='"+str2+"'  ");
				...
				JOptionPane.showMessageDialog(null, str1+ " Deposited Successfully..!!");
